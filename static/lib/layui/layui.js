...
!function (e, t) {
    ...
    r.formatArr = function (e) {
        ...
        if (t.isPreview) {
            ...
            a.html(n).css({color: "#00B2B2"}), setTimeout(function () {
                a.css({color: "#666"})
            }, 300)
        }
...
layui.define(["jquery", "lay"], function (e) {
    ...
    F.prototype.config = {
        ...
        format: "hex",
        predefine: !1,
        colors: ["#1E9FFF", "#00B2B2", "#1E9FFF", "#FF5722", "#FFB800", "#01AAED", "#999", "#c00", "#ff8c00", "#ffd700", "#90ee90", "#00ced1", "#1e90ff", "#c71585", "rgb(0, 186, 189)", "rgb(255, 120, 0)", "rgb(250, 212, 0)", "#393D49", "rgba(0,0,0,.5)", "rgba(255, 69, 0, 0.68)", "rgba(144, 240, 144, 0.5)", "rgba(31, 147, 255, 0.73)"]
    }, F.prototype.render = function () {
